...
#if defined (CONFIG_LGE_PM_CHARGING_SCENARIO_SPRINT)
#define CHG_MAXIDX	5
#else
#define CHG_MAXIDX	7
#endif
...
#if defined (CONFIG_LGE_PM_CHARGING_SCENARIO_SPRINT)
#if defined (CONFIG_MACH_MSM8909_M1_SPR_US) || defined(CONFIG_MACH_MSM8909_ME0_SPR_US)\
	|| defined (CONFIG_MACH_MSM8909_K6B_SPR_US)
