...
#include <linux/input/unified_driver_4_k6p/lgtp_platform_api_power.h>
...
****************************************************************************/
	...
	extern TouchDeviceControlFunction FT8606_Func;
...
TouchDeviceControlFunction * TouchGetDeviceControlFunction(int index)
{
	...
	#elif defined(TOUCH_MODEL_K6B)
	if (index == FIRST_MODULE)
		pControlFunction = &FT8606_Func;
	#elif defined(TOUCH_MODEL_K6P)
    if (index == SECOND_MODULE){//1 : Tovis panel
	    pControlFunction = &td4100_Func;
	}
	TOUCH_LOG("TouchGetDeviceControlFunction!!!!!!!!!!!!!!!!!!!!!\n");
	#else
	#error "Model should be defined"
	#endif
...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	#if defined(TOUCH_MODEL_C70) || defined(TOUCH_MODEL_Y70) || defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_P1C) || defined (TOUCH_MODEL_M1V) || defined (TOUCH_MODEL_M4) || defined ( TOUCH_MODEL_K6M) || defined ( TOUCH_MODEL_K6P )
...
void TouchVddPowerModel(int isOn)
{
	...
	#elif defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_P1C) || defined (TOUCH_MODEL_M1V) || defined (TOUCH_MODEL_M4) || defined (TOUCH_MODEL_K7) || defined ( TOUCH_MODEL_K6M) || defined ( TOUCH_MODEL_K6P )
