...
#if !defined ( TOUCH_MODEL_C70 ) && !defined ( TOUCH_MODEL_C90NAS ) && !defined ( TOUCH_MODEL_P1B ) && !defined ( TOUCH_MODEL_P1C ) && !defined ( TOUCH_MODEL_M209 ) && !defined ( TOUCH_MODEL_YG ) && !defined ( TOUCH_MODEL_M1 )/* TBD : temporally block ( C70 is not ready ) */
