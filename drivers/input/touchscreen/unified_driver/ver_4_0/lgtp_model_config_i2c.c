...
#elif defined( TOUCH_MODEL_ME0 ) || defined( TOUCH_MODEL_LV0 )
static struct of_device_id Ft3x07_MatchTable[] = {
	{ .compatible = "unified_driver4,ft3x07", },
	{ },
};
