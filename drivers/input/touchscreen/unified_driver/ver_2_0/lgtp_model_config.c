...
static TouchDeviceSpecificFunction *pDeviceSpecificFunction[MAX_DEVICE_SUPPORT] = {
        ...
        || defined( TOUCH_MODEL_P1B ) || defined ( TOUCH_MODEL_P1C) || defined ( TOUCH_MODEL_YG ) || defined ( TOUCH_MODEL_M209 )
	...
	#elif defined ( TOUCH_MODEL_M1 ) || defined ( TOUCH_MODEL_LV1 )
		#if defined ( TOUCH_DEVICE_MIT200_PROC4 )
		&MIT200_Func,
		#endif
	#else
...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	#elif defined ( TOUCH_MODEL_C70 ) || defined ( TOUCH_MODEL_C90 ) || defined ( TOUCH_MODEL_Y90 ) || defined ( TOUCH_MODEL_Y70 ) || defined ( TOUCH_MODEL_C90NAS) || defined ( TOUCH_MODEL_P1C) || defined ( TOUCH_MODEL_YG ) || defined ( TOUCH_MODEL_M209 )
	...
	#elif defined ( TOUCH_MODEL_C50 ) || defined ( TOUCH_MODEL_M1 ) || defined ( TOUCH_MODEL_LV1 )
...
void TouchAssertResetModel( void )
{
	...
	#elif defined ( TOUCH_MODEL_C70 ) || defined ( TOUCH_MODEL_C90NAS) || defined( TOUCH_MODEL_P1B ) || defined ( TOUCH_MODEL_P1C) || defined ( TOUCH_MODEL_YG ) || defined ( TOUCH_MODEL_M209 )
