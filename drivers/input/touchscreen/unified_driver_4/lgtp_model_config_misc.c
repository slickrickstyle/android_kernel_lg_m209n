...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	|| defined(TOUCH_MODEL_PH1) || defined(TOUCH_MODEL_M1V) || defined(TOUCH_MODEL_ME0) || defined(TOUCH_MODEL_K6B)  || defined(TOUCH_MODEL_K6P)
...
void TouchVddPowerModel(int isOn)
{
	...
	#elif defined(TOUCH_MODEL_M1V_VZW)
		TouchPowerPMIC_VZW(isOn,"vdd_dd","vdd_ana",3000000, 1800000);
	#elif defined(TOUCH_MODEL_LION_3G) || defined ( TOUCH_MODEL_M2) || defined(TOUCH_MODEL_PH1) || defined(TOUCH_MODEL_M1V) || defined(TOUCH_MODEL_ME0) || defined(TOUCH_MODEL_K6B) || defined(TOUCH_MODEL_K6P)
