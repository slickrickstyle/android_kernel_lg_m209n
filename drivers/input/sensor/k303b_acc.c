...
static void __init async_k303b_acc_init(void *data, async_cookie_t cookie)
{
    int ret = i2c_add_driver(&k303b_acc_driver);
    if (ret)
...
{
    async_schedule(async_k303b_acc_init, NULL);
    return 0;
}
