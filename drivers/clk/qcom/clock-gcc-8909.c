...
static struct clk_freq_tbl ftbl_gcc_mdss_esc0_clk[] = {
	...
	F( 9600000,		xo,	2,	0,	0),
#elif defined (CONFIG_LGD_DB7400_HD_5INCH_VIDEO_PANEL) || defined (CONFIG_LGD_DB7400_HD_LH530WX2_VIDEO_PANEL)
	F( 9600000,	xo,	2, 0,	0),
#else
	F( 19200000,	xo,	1,	0,	0),
#endif
...
#if defined (CONFIG_LGD_DB7400_HD_LH530WX2_VIDEO_PANEL) || defined (CONFIG_LGD_DB7400_HD_5INCH_VIDEO_PANEL)
