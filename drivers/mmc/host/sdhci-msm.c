...
#if defined(CONFIG_MACH_MSM8909_M1_SPR_US) || defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW)
...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	if(hw_rev <= HW_REV_0) {
#elif defined(CONFIG_MACH_MSM8909_M1_TMO_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US) || defined(CONFIG_MACH_MSM8909_M1_TRF_US_VZW)
	if(hw_rev <= HW_REV_A) {
#endif
#endif
...
/*change made to improve booting time*/
