...
//   kthread_bind(pSchedContext->McThread, 0);  // LGE Patch Fixed Rx thread to cpu0
...
//  kthread_bind(pSchedContext->TxThread, 0);  // LGE Patch Fixed Rx thread to cpu0
  ...
  kthread_bind(pSchedContext->RxThread, 2);  // LGE Patch Fixed Rx thread to cpu0
...
//  kthread_bind(pWdContext->WdThread, 0);  // LGE Patch Fixed Wd thread to cpu0
