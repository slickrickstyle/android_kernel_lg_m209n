...
#endif
#if defined(CONFIG_TIANMA_ILI9488_HVGA_CMD_PANEL) || defined (CONFIG_LGE_DISPLAY_LCD_OFF_DIMMING) || defined(CONFIG_LGD_SSD2068_FWVGA_VIDEO_PANEL)
#include <soc/qcom/lge/lge_boot_mode.h>
#endif
#if defined(CONFIG_TIANMA_ILI9488_HVGA_CMD_PANEL) || defined (CONFIG_MACH_MSM8909_K6B_LGU_KR)
...
static int mdss_fb_probe(struct platform_device *pdev)
{
	...
	if(lge_get_boot_mode() == LGE_BOOT_MODE_CHARGERLOGO) mfd->bl_level = 0;
#endif
	}
	else
		mfd->bl_level = 0;
