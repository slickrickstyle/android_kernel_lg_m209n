...
// #define FLASH_INTERFACE // must be enabled when lm3632 is used... 
...
#if defined(CONFIG_BACKLIGHT_LM3632)
	/* Configuration of current, torch : 100mA, strobe : 100mA */
	rc =flash_write_reg(fctrl->flash_i2c_client, 0x06, 0x30);
#else //rt8542
...
#if defined(CONFIG_BACKLIGHT_LM3632)
	/* Configuration of current, torch : 50mA, strobe :400mA */
	rc =flash_write_reg(fctrl->flash_i2c_client,	0x06, 0x13);
#else //rt8542
