...
#elif defined(CONFIG_MSM8909_CF) || defined(CONFIG_LGE_PM_PCB_REV)
#if defined(CONFIG_MSM8909_M1V) || defined(CONFIG_MSM8909_M1V_VZW) || defined(CONFIG_MSM8909_LEAP)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-300,	1660},
	{-200,	1558},
	{-100,	1416},
...
#elif defined(CONFIG_MACH_MSM8909_M209N_TMO_US) || \
...
#elif defined(CONFIG_MSM8909_LV1)
static const struct qpnp_vadc_map_pt adcmap_btm_threshold[] = {
	{-310,	1660},
	{-300,	1652},
	{-290,	1643},
...
int pmic_therm = 0; /* LGE Update for VTS */
#endif
...
#if defined(CONFIG_MSM8909_LV0) || defined(CONFIG_MSM8909_LV1)
	pmic_therm = adc_chan_result->physical; /* LGE Update for VTS */
#endif
 ...
 */
#if defined(CONFIG_MSM8909_LV0) || defined(CONFIG_MSM8909_LV1)
int xo_therm_result = 0; /* LGE Update for VTS */
#endif
...
#if defined(CONFIG_MSM8909_LV0) || defined(CONFIG_MSM8909_LV1)
	xo_therm_result = adc_chan_result->physical;
#endif
...
#if defined(CONFIG_MSM8909_LV0) || defined(CONFIG_MSM8909_LV1)
/* [LGE_UPDATE_S] */
int lge_get_xo_therm(void)
{
	return xo_therm_result;
}
EXPORT_SYMBOL(xo_therm_result);
/* [LGE_UPDATE_E] */
#endif
