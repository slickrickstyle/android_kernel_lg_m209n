...
#if defined (CONFIG_MACH_MSM8909_K6B_LGU_KR) || defined (CONFIG_MACH_MSM8916_YG_SKT_KR) || defined (CONFIG_MACH_MSM8939_P1BSSN_SKT_KR) || defined(CONFIG_MACH_MSM8916_K5_KR)
