...
#if defined(CONFIG_MACH_MSM8909_M1V_ATT_US) || \
	defined(CONFIG_MACH_MSM8909_M1V_ACG_US) || \
	defined(CONFIG_MACH_MSM8909_M1V_USC_US) || \
	defined(CONFIG_MACH_MSM8909_M1V_CRK_US) || \
	defined(CONFIG_MACH_MSM8909_M1V_VZW) || \
	defined(CONFIG_MACH_MSM8909_M1V_LRA_US) || \
	defined(CONFIG_MACH_MSM8909_LEAP_VZW) || \
	defined(CONFIG_MACH_MSM8909_M209N_TMO_US) || \
	defined(CONFIG_MACH_MSM8909_M209N_MPCS_US) || \
	defined(CONFIG_MACH_MSM8909_M209N_ATT_US) || \
	defined(CONFIG_MSM8909_K6B) || \
	defined(CONFIG_MSM8909_K6P) || \
	defined(CONFIG_MACH_MSM8909_ME0_SPR_US) || \
...
static void cpufreq_interactive_timer(unsigned long data)
{
	...
	const char ori_target_loads[] = "1 800000:85 998400:90 1094400:97 1190400:99";
#elif defined(CONFIG_MACH_MSM8909_ME0_SPR_US)
	int ntokens;
	unsigned int *new_target_loads = NULL;
	const char game_target_loads[] = "90 998400:100 1094400:100" ;
	const char ori_target_loads[] = "1 800000:85 998400:90 1094400:97";
#elif defined(CONFIG_MSM8909_K6B) || defined (CONFIG_MSM8909_K6P)
	int ntokens;
	unsigned int *new_target_loads = NULL;
	const char game_target_loads[] = "1 800000:85 998400:95 1094400:90 1190400:95" ;
	const char ori_target_loads[] = "1 800000:85 998400:90 1094400:80 1190400:80";
#endif
