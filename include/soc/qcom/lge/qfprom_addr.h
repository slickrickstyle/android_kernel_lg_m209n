...
#define QFPROM_JTAG_FEATURE_ID      (QFPROM_CTRL_BASE + 0x4000)
#define QFPROM_CORR_SERIAL_NUM      (QFPROM_CTRL_BASE + 0x4008)
...
#define FEATURE_ID_SHIFT 20
qfprom_result_bits feature_id = {QFPROM_VERSION_MAX, QFPROM_JTAG_FEATURE_ID, 0x0FF00000, 0x00000000};
