...
enum pon_restart_reason {
	...
	/*
	 * DM_VERITY reasons are declaired in bootable/bootloader/lk/platform/msm_shared/reboot.h
	 */
	PON_RESTART_REASON_DM_VERITY_LOGGING	= 0x04,
	PON_RESTART_REASON_DM_VERITY_ENFORCING	= 0x05,
	PON_RESTART_REASON_DM_VERITY_KEYSCLEAR	= 0x06,
	/*
	 * Below reasons are LG reboot reason.
	 * Be aware of Bit-2 to bit-7 of SOFT_RB_SPARE for hard reset reason.
	 */
	PON_RESTART_REASON_LGE_REBOOT_NORMAL		= 0x10,
	PON_RESTART_REASON_LGE_NO_CMD			= 0x11,
	PON_RESTART_REASON_LGE_LAF_DLOAD_MODE		= 0x12,
	PON_RESTART_REASON_LGE_ERR_LAF			= 0x13,
	PON_RESTART_REASON_LGE_FOTA			= 0x14,
	PON_RESTART_REASON_LGE_FOTA_LCD_OFF		= 0x15,
	PON_RESTART_REASON_LGE_FOTA_OUT_LCD_OFF		= 0x16,
	PON_RESTART_REASON_LGE_WALLPAPER_FAIL		= 0x17,
	PON_RESTART_REASON_LGE_REBOOT_BATTERY		= 0x18,
	PON_RESTART_REASON_LGE_RECOVERY_KEY_RESET_MODE	= 0x19,
	PON_RESTART_REASON_LGE_HIDDEN_FACTORY_RESET	= 0x1A,
	PON_RESTART_REASON_LGE_LK_DLOAD			= 0x1B,
	PON_RESTART_REASON_LGE_LAF_RESTART_MODE		= 0x1C,
	PON_RESTART_REASON_LGE_CRASH_MODE		= 0x1D,
#endif
};
