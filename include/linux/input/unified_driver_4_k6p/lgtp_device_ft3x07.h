 ...
 *
 *    File  	: lgtp_device_ft3x07.h
 *    Author(s)   : D3 BSP Touch Team < d3-bsp-touch@lge.com >
 *    Description :
 *
 ***************************************************************************/

#if !defined ( _LGTP_DEVICE_FT3X07_H_ )
#define _LGTP_DEVICE_FT3X07_H_
...
#define POINT_READ_BUF			(3 + FT_TOUCH_STEP * FT_MAX_TOUCH_POINTS)
...
/* Touch self test register */
#define FT_DEVICE_MODE			0x00
#define FT_FACTORY_MODE			0xAE
#define FT_START_SCAN			0x08
...
#define FT_REG_PANEL_ID			0xA8
#define FT_REG_FW_REL			0xAF
