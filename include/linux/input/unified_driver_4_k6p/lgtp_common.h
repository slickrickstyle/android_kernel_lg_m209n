...
#include <linux/input/unified_driver_4_k6p/lgtp_project_setting.h>
...
#elif defined(TOUCH_PLATFORM_MT6735P) && defined(CONFIG_USE_OF)
#include <mach/wd_api.h>
#include <upmu_common.h>
#include <mach/upmu_sw.h>
#include <mach/upmu_hw.h>
...
//#include "../../../arch/arm/mach-msm/lge/board_lge.h"
#include <soc/qcom/lge/lge_boot_mode.h>
#elif !defined(TOUCH_PLATFORM_MSM8936)
#include <mach/board.h>
#else
#include <mach/board_lge.h>
#endif
...
typedef struct TouchDeviceControlFunctionTag {
    ...
    //int (*AccessRegister)(int cmd, int reg, int *pValue);
