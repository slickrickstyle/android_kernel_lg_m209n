...
#if defined ( TOUCH_MODEL_E1 ) || defined ( TOUCH_MODEL_CLING )

#define TOUCH_I2C_USE
#define TOUCH_I2C_ADDRESS_8BIT
#define TOUCH_I2C_BUS_NUM 5

#elif defined (TOUCH_MODEL_M2 ) || defined ( TOUCH_MODEL_PH1 ) || defined ( TOUCH_MODEL_M1V ) || defined ( TOUCH_MODEL_ME0 ) || defined( TOUCH_MODEL_K6B ) || defined( TOUCH_MODEL_K6P ) || defined ( TOUCH_MODEL_LV0 )
#define TOUCH_I2C_USE
#define TOUCH_I2C_ADDRESS_8BIT
#define TOUCH_I2C_BUS_NUM 5
