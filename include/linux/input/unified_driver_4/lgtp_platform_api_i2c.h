...
#if defined (TOUCH_DEVICE_SN280H) || defined ( TOUCH_DEVICE_LU202X )
int Semisense_I2C_Read(u8 *cmd, u8 *data, u32 cmd_len, u32 len);
int Semisense_I2C_Write(u8 *cmd, u8 *data, u32 cmd_len, u32 len);
#if defined ( TOUCH_MODEL_CLING ) || defined ( TOUCH_MODEL_E1 ) 
int Lu20xx_I2C_Read (u16 addr, u8 *rxbuf, int len );
int Lu20xx_I2C_Write (u16 addr, u8 *txbuf, int len );
#else
