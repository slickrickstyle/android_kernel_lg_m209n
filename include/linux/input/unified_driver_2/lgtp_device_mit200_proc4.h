...
/*Knock On enable/disable Feature about proximity sensor value*/
...
#define MIP_R0_LCD_IN_SLEEP				0x20
//test value
#define SENSING_ON_OFF					0x23
...
#define RAWDATA_MAX_LIMIT	8700
#define RAWDATA_MIN_LIMIT       600
#define RAWDATA_LPWG_MAX_LIMIT		2700
#define RAWDATA_LPWG_MIN_LIMIT		100
#define JITTER_MAX_LIMIT        50
#define JITTER_MIN_LIMIT        0
...
ssize_t MIT200_GetTestResult(struct i2c_client *client, char *buf, int *result, int type);
