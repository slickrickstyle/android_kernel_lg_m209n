...
struct msm_sensor_power_setting_array {
	...
	struct msm_sensor_power_setting *power_setting_0;
	struct msm_sensor_power_setting *power_setting_a;
	struct msm_sensor_power_setting *power_setting_b;
	uint16_t size;
	uint16_t size_0;
	uint16_t size_a;
	uint16_t size_b;
	struct msm_sensor_power_setting *power_down_setting;
	struct msm_sensor_power_setting *power_down_setting_0;
	struct msm_sensor_power_setting *power_down_setting_a;
	struct msm_sensor_power_setting *power_down_setting_b;
	uint16_t size_down;
...
struct msm_camera_i2c_reg_setting {
	...
	uint16_t *value;	/*LGE_CHANGE, add soc exif, 2015-04-28, ranjith.k@lge.com*/
};
